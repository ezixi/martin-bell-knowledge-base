...
Selected long-form and technical writing covering analytics strategy, product analytics, data engineering and engineering practice.
...
- [How to Choose the Best App Analytics Tools](./best-app-analytics-tools.md)
- [Firebase Analytics Heats Up Google's App Toolset](./firebase-analytics.md)

## Data & Analytics Engineering

- [Anatomy of a Pipeline](./anatomy-of-a-pipeline.md) — CI/CD for dbt and BigQuery using Azure Pipelines.
